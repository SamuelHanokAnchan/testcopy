...
from models.CalculatedArea import CalculatedArea
...
class AreaCalculator:
    ...
    def calculate_corrected_area(self, polygon_points, pixel_size_x, pixel_size_y=None, angle_data=None) -> CalculatedArea:
        """
